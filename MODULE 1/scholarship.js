...
function main(income, gpa, minWage) {
    ...
    var socialScholarship = Math.floor(minWage * 0.35);
    var excellentScholarship = Math.floor(gpa * 25);

    if ((income < minWage) && (gpa >= 4.5) && (socialScholarship > excellentScholarship)) {
